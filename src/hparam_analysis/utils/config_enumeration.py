...
def enumerate_configs(
    ...
    configs = list(product(*[hidden_channel_values, weight_decay_values, dropout_values, lr_values, num_layers_values]))

    configs = [
        {"index": i, "hidden_channels": a, "weight_decay": b, "dropout": c, "lr": d, "num_layers": g}
